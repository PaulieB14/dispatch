...
for var in SERVICE_PROVIDER_ADDRESS DISPATCH_OPERATOR_PRIVATE_KEY DISPATCH_ARBITRUM_RPC DISPATCH_ARBITRUM_BACKEND DATABASE_URL DISPATCH_AGGREGATOR_URL; do
  if [ -z "${!var:-}" ]; then
